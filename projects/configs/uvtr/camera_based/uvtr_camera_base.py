...
db_sampler = dict(
    ...
    data_root=data_root,
    info_path=data_root + 'nuscenes_uvtr_dbinfos_train.pkl', # please change to your own database file
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    val=dict(type=dataset_type, pipeline=test_pipeline, classes=class_names, modality=input_modality,
             ann_file=data_root + "nuscenes_uvtr_infos_val.pkl"), # please change to your own info file
...
load_from='../work_dirs/ckpts/uvtr/pretrain/fcos3d_dcn50.pth' # please download the pretrained model from the our git
# fp16 setting
