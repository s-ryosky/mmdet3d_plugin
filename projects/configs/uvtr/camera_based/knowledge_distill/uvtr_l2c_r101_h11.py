...
model = dict(
    ...
    pretrained_img='../work_dirs/ckpts/uvtr/pretrain/fcos3d.pth', # please download the pretrained model from the our git
    pretrained_pts='../work_dirs/ckpts/uvtr/pretrain/uvtr_l_v01_h5.pth', # please download the pretrained model from the our git
