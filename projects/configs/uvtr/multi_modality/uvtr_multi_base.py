...
model = dict(
    type='UVTR',
    use_grid_mask=True,
    pretrained_img='../work_dirs/ckpts/uvtr/pretrain/uvtr_c_r50_h5.pth', # please download the pretrained model from the our git
    pretrained_pts='../work_dirs/ckpts/uvtr/pretrain/uvtr_l_v0075_h5.pth', # please download the pretrained model from the our git
...
dataset_type = 'NuScenesUVTRDataset'
...
db_sampler = dict(
    ...
    data_root=data_root,
    info_path=data_root + 'nuscenes_uvtr_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_uvtr_infos_train.pkl',  # please change to your own info file
    ...
    val=dict(pipeline=test_pipeline, classes=class_names, modality=input_modality,
             ann_file=data_root + "nuscenes_uvtr_infos_val.pkl"),
